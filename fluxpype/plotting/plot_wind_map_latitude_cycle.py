...
from fluxpype.helpers.pipe_helper import (configurations, load_fits_magnetogram,
...
def plot_wind_map_latitude(configs):
    ...
    carrington = np.loadtxt("/Users/cgilbert/vscode/fluxons/fluxpype/fluxpype/plotting/SN_m_tot_V2.0.txt").T
