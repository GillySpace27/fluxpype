...
class CustomInstallCommand(install):
    ...
    def install_perlbrew(self):
        ...
        if os.path.exists(perlbrew_env):
            subprocess.check_call(["source", perlbrew_env], shell=True)
    ...
    def install_homebrew(self):
        ...
        # required_packages = ["gnuplot", "fftw", "wget"]
        ...
        for package in required_packages:
            try:
                ...
                subprocess.check_call(["brew", "list", package], stdout=subprocess.DEVNULL, stderr=subprocess.DEVNULL)
